...
REQUIRED_FIELDS = ["cheque_id","cheque_number","date","payee_name","amount_number","amount_words","bank_name"]
...
def validate_cheque_data(data: dict):
    ...
    if not data.get("cheque_id") or not str(data.get("cheque_id")).strip():
        error_flags.append("Cheque ID is required.")
